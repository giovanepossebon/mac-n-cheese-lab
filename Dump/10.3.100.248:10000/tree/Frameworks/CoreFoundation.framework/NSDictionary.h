...
@interface NSDictionary : NSObject <AFSecurityDigestibleChunksProviding, CSCoderEncoder, CUByteCodable, NSCopying, NSFastEnumeration, NSFetchRequestResult, NSMutableCopying, NSSecureCoding>
