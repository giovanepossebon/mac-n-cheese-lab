...
@interface NSString : NSObject <AFSecurityDigestibleChunksProviding, CKRecordValue, CKShortDescription, CNKeyDescriptor_Private, CNUIURLDestinationID, CSCoderEncoder, CUByteCodable, NSCopying, NSItemProviderReading, NSItemProviderWriting, NSMutableCopying, NSSecureCoding, SASerializable, UIItemProviderReading, UIItemProviderWriting, _DKDeduping>
